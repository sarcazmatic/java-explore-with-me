...
public class PublicCompilationsController {
    ...
    @GetMapping
    public List<CompilationDto> getCompilations(HttpServletRequest httpServletRequest,
    ...
    @GetMapping("/{compId}")
    public CompilationDto getCompilationById(HttpServletRequest httpServletRequest,
